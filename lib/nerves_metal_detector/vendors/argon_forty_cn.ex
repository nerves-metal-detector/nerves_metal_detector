defmodule NervesMetalDetector.Vendors.ArgonFortyCn do
...
defimpl NervesMetalDetector.Inventory.ProductAvailability.Fetcher,
  for: NervesMetalDetector.Vendors.ArgonFortyCn.ProductUpdate do
  alias NervesMetalDetector.Vendors.ArgonFortyCn

  def fetch_availability(%ArgonFortyCn.ProductUpdate{url: url, sku: sku}) do
    options = [
    ...
    with {:load_body, {:ok, %{body: body}}} when body not in [nil, ""] <-
      ...
      data = %{
        sku: sku,
        vendor: ArgonFortyCn.vendor_info().id,
        url: item_url,
        in_stock: in_stock,
        items_in_stock: nil,
