defmodule NervesMetalDetector.Inventory.Data.ProductUpdateItems do
  ...
  @collections [
    ...
    ProductUpdateItems.BotlandCz,
    ProductUpdateItems.BotlandDe,
    ProductUpdateItems.BotlandEu,
    ProductUpdateItems.BotlandPl,
    ProductUpdateItems.ChicagoElectronicDistributorsUs,
    ProductUpdateItems.ElectrokitSe,
