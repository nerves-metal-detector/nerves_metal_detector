defmodule NervesMetalDetectorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NervesMetalDetectorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NervesMetalDetectorWeb.Gettext, "errors", msg, opts)
    end
  end
